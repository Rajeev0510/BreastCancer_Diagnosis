...
def main() -> None:
    ...
    st.caption("Two apps, one window — switch tabs to view each. (BC_IHC + Main App)")

    this_dir = os.path.dirname(os.path.abspath(__file__))

    # Update these if your file names differ
    bc_ihc_path = os.path.join(this_dir, "bc_ihc_onepage.py")
    main_app_path = os.path.join(this_dir, "app.py")

    # Optional: allow overriding via env vars on Streamlit Cloud
